...
public class BandwidthBlockingProbability extends Measurement{
    ...
    private double bandwidthBlockingByXt;
				...
				if(c.isWasBlocked()){//considers that only one circuit has been blocked
					switch(c.getBlockCause()){
						...
						case Circuit.BY_CROSSTALK:
							this.bandwidthBlockingByXt += bandwidth;
							break;
					}
					break;
				}
    ...
    public double getBandwidthBlockingByXt() {
        return (this.bandwidthBlockingByXt / this.generalRequestedBandwidth);
    }
