...
public class Circuit implements Comparable<Object>, Serializable {
    ...
    public Circuit() {
        ...
        this.spectrumUtilizationAbsolut = new int[7]; // Para calcular os valores de utilização de espectro para Machine Learning
        this.spectrumUtilizationWeighted = new int[7]; // Para calcular os valores de utilização de espectro para Machine Learning
        this.spectrumUtilizationInRoute = new int[7]; // Para calcular os valores de utilização de espectro para Machine Learning
        this.averageXT = new double[7]; // Para calcular a média de XT para Machine Learning
