...
public class Main {
    ...
    private static void localSimulation(String path) throws Exception {
        ...
        System.out.println("Salvando base de dados para rede neural...");
		...
		System.out.println("Core0"+AcineMl.qc0);
		System.out.println("Core1"+AcineMl.qc1);
		System.out.println("Core2"+AcineMl.qc2);
		System.out.println("Core3"+AcineMl.qc3);
		System.out.println("Core4"+AcineMl.qc4);
		System.out.println("Core5"+AcineMl.qc5);
		System.out.println("Core6"+AcineMl.qc6);
    }
